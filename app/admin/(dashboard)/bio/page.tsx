...
export default async function AdminBioPage() {
  ...
  return (
    <div style={{ maxWidth: 900 }}>
      ...
      <form action={saveBioAction} style={{ display: "flex", flexDirection: "column", gap: 32 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 20 }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <input
                ...
                placeholder="e.g. /Sai_Inapakolla_Resume.pdf"
                className="admin-input"
              />
            </div>
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", gap: 16 }}>
          <button type="submit" className="pill-btn pill-btn--cyan" style={{ padding: "14px 36px", fontSize: "0.95rem" }}>
